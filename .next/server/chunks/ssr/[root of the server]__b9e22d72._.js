...
const useWallet = ()=>{
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true); // Initialize loading to true
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const { toast: anothertoast } = useToast(); // Renamed to avoid conflict if any, though `toast` is conventional
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setIsMounted(true);
    }, []);
    const fetchBalance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (currentAccount)=>{
        ...
        // setLoading(true); // setLoading is managed by callers or initial state
        try {
        ...
        // setLoading(false); // setLoading is managed by callers or effects
        }
    }, [
        isMounted
    ]);
    const disconnectWallet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        setError(null);
    // Event listener cleanup is handled in the dedicated useEffect
    }, [
        isMounted,
        anothertoast
    ]);
    const handleAccountsChanged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((accounts)=>{
        if (!isMounted) return;
        if (accounts.length === 0) {
            disconnectWallet(); // Safely uses memoized disconnectWallet
            ...
            anothertoast({
                ...
                description: `Switched to account: ${newAccount.substring(0, 6)}...${newAccount.substring(newAccount.length - 4)}`
            });
        }
    }, [
        isMounted,
    ...
    const connectWallet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            if (accounts.length > 0) {
                ...
                setIsConnected(true);
                await fetchBalance(currentAccount); // Safely uses memoized fetchBalance
                if (typeof localStorage !== 'undefined') {
                    localStorage.setItem('aethermind_wallet_account', currentAccount);
                }
                anothertoast({
                    title: "Wallet Connected",
                    description: `Connected to account: ${currentAccount.substring(0, 6)}...${currentAccount.substring(currentAccount.length - 4)}`
                });
            } else {
    ...
    // Effect for restoring connection
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!isMounted || typeof window.ethereum === 'undefined') {
            // If not mounted or ethereum not available, ensure loading is false if it wasn't a direct connect attempt
            if (!loading) setLoading(false); // Only set to false if not already true from a connect attempt
            return;
        }
        let isActive = true;
            ...
            if (!account && !isConnected) {
                ...
                if (storedAccount) {
                    try {
                        ...
                        // No need to set isConnected/account to false/null, they are already so.
                        }
                    } catch (err) {
                        if (isActive) {
                ...
                if (isActive) setLoading(false); // Already connected or account set, ensure loading is false
            }
        };
        ...
        account,
        isConnected
    ]); // Added account & isConnected to deps
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        return ()=>{
            ...
            if (typeof window.ethereum.removeListener === 'function') {
                // No need to check isConnected/account here, just try to remove if the function exists
...
const formatBalanceForAI = (balance)=>{
    ...
    const nativeCurrency = balance.find((token)=>token.symbol === 'ETH'); // Assuming ETH as primary, adjust if needed
...
"[project]/src/components/aethermind/WalletConnect.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function WalletConnect() {
    const { isConnected, account, connectWallet, disconnectWallet, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useWallet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWallet"])();
    if (loading) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b9e22d72._.js.map